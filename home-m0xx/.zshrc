...
# EXPORT PATH
export PATH=/usr/local/sbin:/usr/local/bin:/opt/nvim-linux64/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/games:/usr/games:/home/m0xx/.fzf/bin
...
source /home/m0xx/powerlevel10k/powerlevel10k.zsh-theme
...
function settarget(){
    ip_address=$1
    machine_name=$2
    echo "$ip_address $machine_name" > /home/m0xx/.config/bin/target
}

function cleartarget(){
    echo '' > /home/m0xx/.config/bin/target
}
